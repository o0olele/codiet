 ...
 */
object CodietStatisticAnalyzer {
    /**
    ...
    fun makeSingleLineIfNeeded(suggestion: String): String {
        if (CodietStatistic.totalCompletionsNumber > TOTAL_COMPLETIONS_NUMBER_THRESHOLD &&
            CodietStatistic.userEngagement < USER_ENGAGEMENT_THRESHOLD &&
            '\n' in suggestion
        ) {
