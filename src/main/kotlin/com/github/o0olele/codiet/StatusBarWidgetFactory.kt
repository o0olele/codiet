 ...
 */
class CodietStatusBarWidgetFactory : StatusBarWidgetFactory {
    /**
     ...
     */
    override fun createWidget(project: Project) = CodietStatusBarWidget(project)
 ...
 */
class CodietStatusBarWidget(project: Project) : EditorBasedWidget(project), StatusBarWidget.TextPresentation {
    /**
 ...
 */
object CodietStatusBarWidgetManager {
    /**
     ...
     */
    private fun update(updateField: CodietStatusBarWidget.() -> Unit) {
        WindowManager.getInstance().getStatusBar(ProjectManager.getInstance().openProjects.first())?.also { statusBar ->
            statusBar.getWidget(CodietStatusBarWidget.ID)?.apply {
                if (this is CodietStatusBarWidget) {
                    updateField()
                    statusBar.updateWidget(CodietStatusBarWidget.ID)
                }
            }
        }
    }
