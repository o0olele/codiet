...
object CodietCacheStatistic {
    ...
    fun onCacheMiss() {
        ...
        CodietStatusBarWidgetManager.updateCacheMissNumber(cacheMissNumber.get())
    }
    ...
    fun onCacheHit() {
        ...
        CodietStatusBarWidgetManager.updateCacheHitNumber(cacheHitNumber.get())
    }
